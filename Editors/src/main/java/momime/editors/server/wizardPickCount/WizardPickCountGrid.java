 ...
 */
public class WizardPickCountGrid extends XmlEditorGrid
{
	/**
	 ...
	 */
	public WizardPickCountGrid (final Element anEntityElement, final ComplexTypeReference aTypeDefinition,
