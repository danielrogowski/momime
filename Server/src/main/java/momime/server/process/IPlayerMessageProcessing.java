...
public interface IPlayerMessageProcessing
{
	 ...
	 */
	public void checkIfCanStartGame (final IMomSessionVariables mom, final Logger debugLogger)
	 ...
	 */
	public void switchToNextPlayer (final IMomSessionVariables mom, final Logger debugLogger)
	 ...
	 */
	public void nextTurnButton (final IMomSessionVariables mom, final PlayerServerDetails player, final Logger debugLogger)
		throws JAXBException, XMLStreamException, RecordNotFoundException, PlayerNotFoundException, MomException;
}
