...
public interface IMemoryBuildingUtils
{
	 ...
	 */
	public OverlandMapCoordinates findCityWithBuilding (final int playerID, final String buildingID, final MapVolumeOfMemoryGridCells map,
	 ...
	 */
	public String doAnyBuildingsDependOn (final List<MemoryBuilding> buildingsList, final OverlandMapCoordinates cityLocation,
