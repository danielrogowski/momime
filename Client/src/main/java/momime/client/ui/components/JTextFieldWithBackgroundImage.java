...
/**
 * JTextField, where an image is used to draw the background rather than the default drawing.
 * The size of the component is then fixed to the size of the image.
 */
public final class JTextFieldWithBackgroundImage extends JTextField
{
	/** Unique value for serialization */
	private static final long serialVersionUID = 8623098626791194690L;
