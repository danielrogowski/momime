...
/**
 * Tests the SmoothingSystemGfx class
 */
public final class TestSmoothingSystemGfx
{
	/**
	...
	public final void testListUnsmoothedBitmasks_MaxValue0 ()
	{
		...
		final SmoothingSystemGfx ss = new SmoothingSystemGfx ();
	...
	public final void testApplySmoothingReductionRules () throws MomException
	{
		...
		final SmoothingReductionGfx rule1 = new SmoothingReductionGfx ();
		...
		final SmoothingReductionGfx rule2 = new SmoothingReductionGfx ();
		...
		final SmoothingReductionGfx rule3 = new SmoothingReductionGfx ();
	...
	public final void testBuildMap () throws MomException
	{
		...
		final SmoothingReductionGfx rule4 = new SmoothingReductionGfx ();
