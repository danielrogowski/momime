...
public final class CombatMapBitmapGeneratorImpl implements CombatMapBitmapGenerator
{
	 ...
	 * @param combatPlane Which plane the combat is taking place on
	 * @return Array of combat map bitmaps
	 * @throws IOException If there is a problem loading any of the images
	 */
	@Override
	public final BufferedImage [] generateCombatMapBitmaps (final MapAreaOfCombatTiles combatTerrain, final Plane combatPlane) throws IOException
	{
		final CombatMapSize mapSize = getClient ().getSessionDescription ().getCombatMapSize ();
		...
		{
			final BufferedImage cloudBackground = getUtils ().loadImage (combatPlane.getCloudCombatImageFile ());
			for (int frameNo = 0; frameNo < combatMapTileSet.getAnimationFrameCount (); frameNo++)
