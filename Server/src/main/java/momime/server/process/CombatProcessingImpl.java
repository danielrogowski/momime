...
public final class CombatProcessingImpl implements CombatProcessing
{
	 ...
	 */
	@Override
	public final boolean okToMoveUnitInCombat (final ExpandedUnitDetails tu, final MapCoordinates2DEx moveTo,
		...
		throws MomException, PlayerNotFoundException, RecordNotFoundException, JAXBException, XMLStreamException
	{
		...
		log.trace ("Exiting okToMoveUnitInCombat = " + combatEnded);
		return combatEnded;
	}
