...
public final class TestSpellQueueingImpl
{
	...
	public final void testRequestCastSpell_QueueOverlandSpell () throws Exception
	{
		...
		assertEquals ("SP001", priv.getQueuedSpellID ().get (0));
	...
	public final void testRequestCastSpell_UnitEnchantmentInCombat_InvalidTarget () throws Exception
	{
		...
		when (memoryMaintainedSpellUtils.isUnitValidTargetForSpell (spell, SpellCastType.COMBAT, attackingPd.getPlayerID (), null, targetUnit,
