 ...
 */
public final class MomServerSpellCalculations implements IMomServerSpellCalculations
{
	/** Class logger */
	private final Logger log = Logger.getLogger (MomServerSpellCalculations.class.getName ());
	...
	{
		log.entering (MomServerSpellCalculations.class.getName (), "randomizeResearchableSpells");
		...
		log.exiting (MomServerSpellCalculations.class.getName (), "randomizeResearchableSpells");
	}
	...
	public final void randomizeSpellsResearchableNow (final List<SpellResearchStatus> spells, final ServerDatabaseEx db)
		throws RecordNotFoundException
	{
		log.entering (MomServerSpellCalculations.class.getName (), "randomizeSpellsResearchableNow");
		...
		log.exiting (MomServerSpellCalculations.class.getName (), "randomizeSpellsResearchableNow");
	}
