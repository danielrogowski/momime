...
import momime.client.language.database.v0_9_8.Building;
import momime.client.language.database.v0_9_8.CitySize;
import momime.client.language.database.v0_9_8.CitySpellEffect;
import momime.client.language.database.v0_9_8.CombatAreaEffect;
import momime.client.language.database.v0_9_8.DamageType;
import momime.client.language.database.v0_9_8.DifficultyLevel;
import momime.client.language.database.v0_9_8.FogOfWarSetting;
import momime.client.language.database.v0_9_8.Hero;
import momime.client.language.database.v0_9_8.HeroItemBonus;
import momime.client.language.database.v0_9_8.HeroItemSlotType;
import momime.client.language.database.v0_9_8.HeroItemType;
import momime.client.language.database.v0_9_8.KnownServer;
import momime.client.language.database.v0_9_8.LandProportion;
import momime.client.language.database.v0_9_8.LanguageCategory;
import momime.client.language.database.v0_9_8.LanguageDatabase;
import momime.client.language.database.v0_9_8.MapFeature;
import momime.client.language.database.v0_9_8.NodeStrength;
import momime.client.language.database.v0_9_8.ObjectFactory;
import momime.client.language.database.v0_9_8.OverlandMapSize;
import momime.client.language.database.v0_9_8.Pick;
import momime.client.language.database.v0_9_8.PickType;
import momime.client.language.database.v0_9_8.Plane;
import momime.client.language.database.v0_9_8.PopulationTask;
import momime.client.language.database.v0_9_8.ProductionType;
import momime.client.language.database.v0_9_8.Race;
import momime.client.language.database.v0_9_8.RangedAttackType;
import momime.client.language.database.v0_9_8.ShortcutKey;
import momime.client.language.database.v0_9_8.Spell;
import momime.client.language.database.v0_9_8.SpellBookSection;
import momime.client.language.database.v0_9_8.SpellRank;
import momime.client.language.database.v0_9_8.SpellSetting;
import momime.client.language.database.v0_9_8.TileType;
import momime.client.language.database.v0_9_8.Unit;
import momime.client.language.database.v0_9_8.UnitSetting;
import momime.client.language.database.v0_9_8.UnitSkill;
import momime.client.language.database.v0_9_8.UnitType;
import momime.client.language.database.v0_9_8.Wizard;
