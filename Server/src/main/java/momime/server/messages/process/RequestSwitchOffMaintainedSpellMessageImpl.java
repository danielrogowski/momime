 ...
 */
public final class RequestSwitchOffMaintainedSpellMessageImpl extends RequestSwitchOffMaintainedSpellMessage implements IProcessableClientToServerMessage
{
	/** Class logger */
