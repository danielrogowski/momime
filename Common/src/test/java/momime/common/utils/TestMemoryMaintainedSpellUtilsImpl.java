...
public final class TestMemoryMaintainedSpellUtilsImpl
{
	...
	public final void testIsUnitValidTargetForSpell_Summoning_Ours () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.VALID_TARGET, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Summoning_NotInCombat () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.UNIT_NOT_IN_EXPECTED_COMBAT, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Summoning_WrongLifeformType () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.UNIT_INVALID_MAGIC_REALM_LIFEFORM_TYPE, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Summoning_EnemyDisallowed () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.RAISING_ENEMY, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitEnchantment_Overland () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.VALID_TARGET, utils.isUnitValidTargetForSpell (spell, null, null, 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitEnchantment_Enemy () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.ENCHANTING_OR_HEALING_ENEMY, utils.isUnitValidTargetForSpell (spell, null, null, 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitEnchantment_NoEffectsDefined () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.NO_SPELL_EFFECT_IDS_DEFINED, utils.isUnitValidTargetForSpell (spell, null, null, 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitEnchantment_HaveAllEffects () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.ALREADY_HAS_ALL_POSSIBLE_SPELL_EFFECTS, utils.isUnitValidTargetForSpell (spell, null, null, 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitEnchantment_WrongLifeformType () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.UNIT_INVALID_MAGIC_REALM_LIFEFORM_TYPE, utils.isUnitValidTargetForSpell (spell, null, null, 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitEnchantment_Dead () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.UNIT_DEAD, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitCurse_OurUnit () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.CURSING_OR_ATTACKING_OWN, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitCurse_NoEffectsDefined () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.NO_SPELL_EFFECT_IDS_DEFINED, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_UnitCurse_HaveAllEffects () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.ALREADY_HAS_ALL_POSSIBLE_SPELL_EFFECTS, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_NormalAttack_Immune () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.IMMUNE, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_ResistanceRoll_ResistanceTooHigh () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.TOO_HIGH_RESISTANCE, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_ResistanceRoll_VariableSavingThrowModifier () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.VALID_TARGET, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, 4, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Healing_Enemy () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.ENCHANTING_OR_HEALING_ENEMY, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Healing_WrongLifeformType () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.UNHEALABLE_LIFEFORM_TYPE, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Healing_Undamaged () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.UNDAMAGED, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Healing_PermanentDamage () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.PERMANENTLY_DAMAGED, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsUnitValidTargetForSpell_Dispel_OursEnchanted_EnemyCursed () throws Exception
	{
		...
		// Run method
		assertEquals (TargetSpellResult.NOTHING_TO_DISPEL, utils.isUnitValidTargetForSpell (spell, null, new MapCoordinates3DEx (20, 10, 1), 1, null, null, xu, fow, null, db));
	}
	...
	public final void testIsCityValidTargetForSpell () throws Exception
	{
		...
		// Can't see location
		assertEquals (TargetSpellResult.CANNOT_SEE_TARGET, utils.isCityValidTargetForSpell (spells, enchantment, 1, new MapCoordinates3DEx (20, 20, 0), map, fow, buildings, players));
		
		// No city
		fow.getPlane ().get (0).getRow ().get (20).getCell ().set (20, FogOfWarStateID.CAN_SEE);
		assertEquals (TargetSpellResult.NO_CITY_HERE, utils.isCityValidTargetForSpell (spells, enchantment, 1, new MapCoordinates3DEx (20, 20, 0), map, fow, buildings, players));
		
		// Wrong owner
		assertEquals (TargetSpellResult.CURSING_OR_ATTACKING_OWN, utils.isCityValidTargetForSpell (spells, curse, 1, new MapCoordinates3DEx (23, 20, 0), map, fow, buildings, players));
		assertEquals (TargetSpellResult.ENCHANTING_OR_HEALING_ENEMY, utils.isCityValidTargetForSpell (spells, enchantment, 1, new MapCoordinates3DEx (24, 20, 0), map, fow, buildings, players));
		
		// No spell effects defined
		assertEquals (TargetSpellResult.NO_SPELL_EFFECT_IDS_DEFINED, utils.isCityValidTargetForSpell (spells, enchantment, 1, new MapCoordinates3DEx (23, 20, 0), map, fow, buildings, players));
		
		// Spell that creates a building
		enchantment.setBuildingID ("BL01");
		assertEquals (TargetSpellResult.VALID_TARGET, utils.isCityValidTargetForSpell (spells, enchantment, 1, new MapCoordinates3DEx (23, 20, 0), map, fow, buildings, players));
		
		when (memoryBuildingUtils.findBuilding (buildings, new MapCoordinates3DEx (23, 20, 0), "BL01")).thenReturn (new MemoryBuilding ());
		assertEquals (TargetSpellResult.CITY_ALREADY_HAS_BUILDING, utils.isCityValidTargetForSpell (spells, enchantment, 1, new MapCoordinates3DEx (23, 20, 0), map, fow, buildings, players));
		...
		spells.add (effect2);
		assertEquals (TargetSpellResult.ALREADY_HAS_ALL_POSSIBLE_SPELL_EFFECTS, utils.isCityValidTargetForSpell (spells, enchantment, 1, new MapCoordinates3DEx (23, 20, 0), map, fow, buildings, players));
	}
