...
import momime.client.graphics.database.v0_9_9.Animation;
import momime.client.graphics.database.v0_9_9.Building;
import momime.client.graphics.database.v0_9_9.CityImage;
import momime.client.graphics.database.v0_9_9.CityViewElement;
import momime.client.graphics.database.v0_9_9.CombatAction;
import momime.client.graphics.database.v0_9_9.CombatAreaEffect;
import momime.client.graphics.database.v0_9_9.CombatTileBorderImage;
...
import momime.client.graphics.database.v0_9_9.HeroItemSlotType;
import momime.client.graphics.database.v0_9_9.HeroItemType;
import momime.client.graphics.database.v0_9_9.MapFeature;
import momime.client.graphics.database.v0_9_9.ObjectFactory;
import momime.client.graphics.database.v0_9_9.Pick;
import momime.client.graphics.database.v0_9_9.PlayList;
import momime.client.graphics.database.v0_9_9.ProductionType;
import momime.client.graphics.database.v0_9_9.Race;
import momime.client.graphics.database.v0_9_9.RangedAttackType;
import momime.client.graphics.database.v0_9_9.RangedAttackTypeCombatImage;
import momime.client.graphics.database.v0_9_9.SmoothedTile;
import momime.client.graphics.database.v0_9_9.SmoothedTileType;
import momime.client.graphics.database.v0_9_9.SmoothingSystem;
import momime.client.graphics.database.v0_9_9.Spell;
import momime.client.graphics.database.v0_9_9.TileSet;
...
import momime.client.graphics.database.v0_9_9.UnitSkill;
...
import momime.client.graphics.database.v0_9_9.WeaponGrade;
import momime.client.graphics.database.v0_9_9.Wizard;
