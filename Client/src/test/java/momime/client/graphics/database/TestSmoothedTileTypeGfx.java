...
/**
 * Tests the SmoothedTileTypeGfx class
 */
public final class TestSmoothedTileTypeGfx
{
	/**
	 ...
	 */
	private final SmoothedTileGfx createSmoothedTile (final String bitmask, final String tileFile)
	{
		final SmoothedTileGfx tile = new SmoothedTileGfx ();
	...
	public final void testBuildMap () throws RecordNotFoundException
	{
		...
		final SmoothedTileTypeGfx tt = new SmoothedTileTypeGfx ();
	...
	public final void testGetRandomImage () throws RecordNotFoundException
	{
		...
		final List<SmoothedTileGfx> images = new ArrayList<SmoothedTileGfx> ();
		...
		// Run method
		final SmoothedTileGfx tile = tt.getRandomImage ("A1");
