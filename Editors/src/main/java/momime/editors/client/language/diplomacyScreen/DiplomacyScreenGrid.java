...
public final class DiplomacyScreenGrid extends MoMEditorGridWithDiplomacyMessagesImport
{
		...
		throws IOException, XmlEditorException
	{
		...
		importDiplomacyMessages (list, 735, LanguageEditorDatabaseConstants.TAG_ENTITY_PROPOSE_PEACE_TREATY_PHRASE, language);
		importDiplomacyMessages (list, 795, LanguageEditorDatabaseConstants.TAG_ENTITY_ACCEPT_PEACE_TREATY_PHRASE, language);
		...
		importDiplomacyMessages (list, 1005, LanguageEditorDatabaseConstants.TAG_RESPOND_TO_THREAT_IGNORE_PHRASE, language);
		importDiplomacyMessages (list, 1050, LanguageEditorDatabaseConstants.TAG_RESPOND_TO_THREAT_SPELL_PHRASE, language);
		importDiplomacyMessages (list, 615, LanguageEditorDatabaseConstants.TAG_RESPOND_TO_THREAT_WAR_PHRASE, language);
	}
