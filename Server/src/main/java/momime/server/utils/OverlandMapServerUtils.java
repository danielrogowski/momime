...
public final class OverlandMapServerUtils implements IOverlandMapServerUtils
{
	...
	{
		log.entering (OverlandMapServerUtils.class.getName (), "attemptToMeldWithNode", new String []
		...
		log.exiting (OverlandMapServerUtils.class.getName (), "attemptToMeldWithNode", successful);
	}
