...
public final class LanguageEditor
{
	...
	public static void main (final String [] args)
	{
		...
		try
		{
			...
			final ServerXsdResourceResolver resourceResolver = new ServerXsdResourceResolver (DOMImplementationRegistry.newInstance (), debugLogger);
			...
			final AskForXsdAndXmlFileLocations ask = new AskForXsdAndXmlFileLocations
				(new SAXBuilder (), schemaFactory, new LanguageEditorDispatcher (), resourceResolver);

			ask.setLoadXsdFromClasspath (true);
			ask.setXsdFilename (LanguageDatabaseConstants.LANGUAGE_XSD_LOCATION);
		}
		catch (final Exception e)
		{
