...
public interface CityCalculations
{
	 ...
	 */
	public void addProductionFromFortressPickType (final CityProductionBreakdownsEx productionValues, final PickType pickType, final int pickTypeCount);
	 ...
	 */
	public void addProductionFromFortressPlane (final CityProductionBreakdownsEx productionValues, final Plane plane);
	 ...
	 */
	public void halveAddPercentageBonusAndCapProduction (final PlayerPublicDetails cityOwner, final CityProductionBreakdown thisProduction, final DifficultyLevel difficultyLevel, final CommonDatabase db)
