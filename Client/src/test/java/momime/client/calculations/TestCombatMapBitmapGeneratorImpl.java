...
public final class TestCombatMapBitmapGeneratorImpl extends ClientTestData
{
	...
	public final void testGenerateCombatMapBitmap () throws Exception
	{
		...
		final URL xmlResource = getClass ().getResource ("/momime.unittests.mapstorage/generatedCombatMap.xml");
		...
		final MapVolumeOfMemoryGridCells overlandMap = createOverlandMap (overlandMapSize);
		...
		gen.setGraphicsDB (loadGraphicsDatabase (utils, random));
